...
<div class="row row-sponsor py-4">
    ...
    <div class="col col-sponsor">
        ...
        <div class="card-sponsor">
            <div class="title text-uppercase d-flex justify-content-center align-items-center @if ($sponsor->name === 'silver')
                silver
            ...
            <div class="content">
              ...
              <a href="{{route('admin.payment.index', ['sponsor' => $sponsor , 'house' => $house])}}" class="btn btn-sponsor">Compra</a>
            </div>
